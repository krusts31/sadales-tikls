...
healthy_count=$(docker compose -f $DIR/../docker-compose-dev.yaml --env-file $DIR/../.env-dev ps | grep 'healthy' | wc -l)
unhealthy_count=$(docker compose -f $DIR/../docker-compose-dev.yaml --env-file $DIR/../.env-dev ps | grep 'unhealthy' | wc -l)
...
while [[ $healthy_count -lt 3 && $unhealthy_count -eq 0 ]]; do
    ...
    docker compose -f $DIR/../docker-compose-dev.yaml --env-file $DIR/../.env-dev ps
    sleep 5
